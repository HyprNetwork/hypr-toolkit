...
it("renders correctly with unit prop and switchEditingUnits", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c9:hover:not(:disabled):not(.hypr-button--disabled):not(.hypr-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c9:active:not(:disabled):not(.hypr-button--disabled):not(.hypr-button--disabled) {
      opacity: 0.85;
