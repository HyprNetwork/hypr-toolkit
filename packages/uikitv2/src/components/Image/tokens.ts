/**
 * @see https://github.com/hyprswap/hypr-frontend/blob/develop/src/config/constants/tokens.ts
 */
const tokens = {
  cake: {
    symbol: "CAKE",
    ...
    decimals: 18,
    projectLink: "https://hyprswap.finance/",
  },
  txl: {
    symbol: "TXL",
    address: {
  ...
  bunny: {
    ...
    decimals: 18,
    projectLink: "https://hyprbunny.finance/",
  },
  alice: {
    symbol: "ALICE",
    address: {
