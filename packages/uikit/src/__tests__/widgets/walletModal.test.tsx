...
it("renders ConnectModal correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c7:hover:not(:disabled):not(.hypr-button--disabled):not(.hypr-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c7:active:not(:disabled):not(.hypr-button--disabled):not(.hypr-button--disabled) {
      opacity: 0.85;
    ...
    .c15:hover:not(:disabled):not(.hypr-button--disabled):not(.hypr-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c15:active:not(:disabled):not(.hypr-button--disabled):not(.hypr-button--disabled) {
      opacity: 0.85;
      -webkit-transform: translateY(1px);
      -ms-transform: translateY(1px);
      transform: translateY(1px);
    ...
    .c22:hover:not(:disabled):not(.hypr-button--disabled):not(.hypr-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c22:active:not(:disabled):not(.hypr-button--disabled):not(.hypr-button--disabled) {
      opacity: 0.85;
      -webkit-transform: translateY(1px);
      -ms-transform: translateY(1px);
      transform: translateY(1px);
      ...
      >
        ...
        >
          ...
          >
            ...
            <a
              class="c22"
              href="https://docs.hyprswap.finance/get-started/connection-guide"
