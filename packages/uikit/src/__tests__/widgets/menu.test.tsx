...
it("renders correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c3:hover:not(:disabled):not(.hypr-button--disabled):not(.hypr-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c3:active:not(:disabled):not(.hypr-button--disabled):not(.hypr-button--disabled) {
      opacity: 0.85;
    ...
    .c23:hover:not(:disabled):not(.hypr-button--disabled):not(.hypr-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c23:active:not(:disabled):not(.hypr-button--disabled):not(.hypr-button--disabled) {
      opacity: 0.85;
      -webkit-transform: translateY(1px);
      -ms-transform: translateY(1px);
      transform: translateY(1px);
